...
Body 
    ...
    - ssh -i "codeconnect-secret.pem" ubuntu@ec2-13-61-174-105.eu-north-1.compute.amazonaws.com
    ...
    - Backend
        ...
        - npm intsall pm2 -g
        - pm2 start npm --name "codeConnect-backend" -- start
        - pm2 logs
...
# Ngxinx config: 
        ...
        Frontend = http://http://13.61.174.105//
        Backend = http://http://13.61.174.105/:7777/
    
        Domain name = devtinder.com => 13.61.174.105
...
Press Ctrl + O → This means Write Out (save the file).

It will prompt: File Name to Write: <filename> — just press Enter to confirm.

Press Ctrl + X → This means Exit Nano.
